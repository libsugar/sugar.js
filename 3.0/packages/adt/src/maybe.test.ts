...
test('isSome', () => {
    expect(Maybe.isSome(1)).toBeTruthy()
    expect(Maybe.isSome(null)).toBeFalsy()
    expect(Maybe.isSome(void 0)).toBeFalsy()
})

test('isNone', () => {
    expect(Maybe.isNone(1)).toBeFalsy()
    expect(Maybe.isNone(null)).toBeTruthy()
    expect(Maybe.isNone(void 0)).toBeTruthy()
})
